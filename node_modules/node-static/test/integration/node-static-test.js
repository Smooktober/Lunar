...
headers = {
  'requesting headers': {
    topic : function(){
      request.head(TEST_SERVER + '/s.html', this.callback);
    }
  }
}
...
.addBatch({
  ...
  'serving s.html from the cache': {
    topic : function(){
      request.get(TEST_SERVER + '/s.html', this.callback);
    },
    'should respond with 200' : function(error, response, body){
      assert.equal(response.statusCode, 200);
    },
  ...
  'requesting with If-None-Match': {
    topic : function(){
      var _this = this;
      request.get(TEST_SERVER + '/s.html', function(error, response, body){
        request({
          method: 'GET',
          uri: TEST_SERVER + '/s.html',
...
.addBatch({
  'requesting POST': {
    topic : function(){
      request.post(TEST_SERVER + '/s.html', this.callback);
    },
    'should respond with 200' : function(error, response, body){
      assert.equal(response.statusCode, 200);
    },
